...
\bigskip El módulo de recomendación en tiempo real podría realizar el cálculo de recomendación con distintos enfoques. A continuación, se mencionan algunos que pueden ser utilizados en conjunto con algunas observaciones para cada uno de ellos.
