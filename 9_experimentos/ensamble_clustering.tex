...
\end{python}
El numerador de la expresión es la cantidad de veces que dos preguntas coincidieron en el mismo cluster para una misma ejecución, y el denominador la cantidad total de ejecuciones, respondiendo a la fórmula de Ensamble de Clustering de Acumulacion de Evidencias:
\[C(i,j)=\frac{n_{ij}}{N}.\]
