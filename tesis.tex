...
\begin{document}
	...
	\input{0_dedicatoria/dedicatoria}
	\input{1_resumen/resumen}
	...
	\input{5_introduccion/introduccion}
	\input{6_fundamentacion/fundamentacion}
	\input{7_marco_teorico/marco_teorico}
	\input{8_problema_investigacion/problema_investigacion}
	\input{9_experimentos/experimentos}
	\input{10_resultados/resultados}
	\input{11_conclusiones/conclusiones}
	\input{12_anexos/anexos}

	\bibliographystyle{flexbib}
	\bibliography{13_bibliografia/bibliografia}
\end{document}
