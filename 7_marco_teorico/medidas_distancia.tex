...
\bigskip Entonces, la capa de salida es una palabra \(y_j\) codificada como un vector one-hot de dimensión \(V\). Este tipo de técnica se llama \textit{propagación hacia adelante}.
